...
const content = {
  ...
  '/terms': {
    ...
    sections: [
      ...
      { title: 'Fees and payments', body: 'NextDoorLearn may display volunteer or hourly-rate preferences but does not currently process tutoring payments. Any off-platform payment arrangement is between the student or guardian and tutor. Never send banking credentials through platform messages.' },
