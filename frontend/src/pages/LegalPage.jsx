...
const content = {
  '/privacy': {
    ...
    sections: [
      ...
      { title: 'Who receives information', body: 'Relevant profile and session information is shared with matched students or tutors. Approved service providers may process data for hosting, database storage, email delivery, video meetings, calendar sync, mobile notifications, and security. NextDoorLearn does not sell personal information or use it for targeted advertising.' },
  ...
  '/terms': {
    ...
    sections: [
      ...
      { title: 'Fees and payments', body: 'Tutors may volunteer or list a rate up to $25 per hour. NextDoorLearn does not currently process tutoring payments. Any off-platform payment arrangement is between the student or guardian and tutor. Never send banking credentials through platform messages.' },
      { title: 'Sessions and cancellations', body: 'Users should keep availability accurate, attend confirmed sessions, and communicate promptly about changes. A session request is not final until confirmed when confirmation is required. Meeting links are for the scheduled participants and must not be shared publicly.' },
      ...
      { title: 'Third-party services', body: 'Optional features may use providers such as Zoom, Google Calendar, email delivery, hosting, database, and mobile notification services. Their own terms and privacy practices apply when you choose to use them.' },
